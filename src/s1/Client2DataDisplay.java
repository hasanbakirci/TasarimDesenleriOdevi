...
public class Client2DataDisplay implements Observer{
    ...
    public String display() {
        String gidici = testSayisi +"-_-"+hastaSaysi+"-_-"+olumSayisi+"-_-"+tarihGun+"-_-"+toplamTestSayisi+"-_-"+toplamHastaSayisi+"-_-"+toplamOlumSayisi+"-_-"+toplamYbakimSayisi+"-_-"+toplamEhastaSayisi+"-_-"+toplamIyilesenSayisi+"-_-"+tarihAy+"-_-"+tarihYil;
